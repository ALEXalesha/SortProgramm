...
Один и тот же файл в SortProgramm (старое окно --tk), IntelegienceDrawer и AiCar
(окно pygame берёт отсюда только restore, work_areas, load и save). Правило выбора
